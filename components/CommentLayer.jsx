...
const styles = {
  ...
  pin: { position: "absolute", transform: "translate(-50%, -100%)", width: 28, height: 28, borderRadius: "50% 50% 50% 2px", border: "2px solid #FFFFFF", background: BLUE, color: "#FFFFFF", fontFamily: FONT, fontSize: 12, fontWeight: 700, cursor: "pointer", pointerEvents: "auto", boxShadow: "0 6px 16px -4px rgba(37,99,235,0.5)", display: "inline-flex", alignItems: "center", justifyContent: "center" },
  pinActive: { background: INK, boxShadow: "0 8px 20px -4px rgba(17,17,26,0.5)" },
  bubble: { position: "absolute", transform: "translate(14px, -12px)", width: 268, pointerEvents: "auto", background: "#FFFFFF", border: `1px solid ${BORDER}`, borderRadius: 12, boxShadow: "0 18px 48px -16px rgba(17,17,26,0.4)", padding: 12, display: "flex", flexDirection: "column", gap: 10, fontFamily: FONT },
  textarea: { width: "100%", minHeight: 64, resize: "vertical", border: `1px solid ${BORDER}`, borderRadius: 8, padding: "8px 10px", fontFamily: FONT, fontSize: 13, color: INK, outline: "none", boxSizing: "border-box" },
  ...
  fab: { display: "inline-flex", alignItems: "center", gap: 8, height: 40, paddingInline: 16, borderRadius: 999, border: `1px solid ${BORDER}`, background: "#FFFFFF", color: INK, fontFamily: FONT, fontSize: 13, fontWeight: 700, cursor: "pointer", boxShadow: "0 14px 34px -14px rgba(17,17,26,0.45)" },
  fabActive: { borderColor: BLUE, boxShadow: "0 0 0 3px rgba(37,99,235,0.18), 0 14px 34px -14px rgba(17,17,26,0.45)" },
  notesBtn: { display: "inline-flex", alignItems: "center", gap: 7, height: 40, paddingInline: 14, borderRadius: 999, border: `1px solid ${BORDER}`, background: "#FFFFFF", color: INK, fontFamily: FONT, fontSize: 13, fontWeight: 700, cursor: "pointer", boxShadow: "0 14px 34px -14px rgba(17,17,26,0.45)" },
  notesBtnOn: { background: INK, color: "#FFFFFF", border: "1px solid transparent" },
  panel: { position: "fixed", top: 0, right: 0, height: "100%", width: 320, zIndex: 9997, background: "#FFFFFF", borderLeft: `1px solid ${BORDER}`, boxShadow: "-18px 0 48px -24px rgba(17,17,26,0.4)", display: "flex", flexDirection: "column", fontFamily: FONT },
  ...
  modeBar: { position: "fixed", top: 16, left: "50%", transform: "translateX(-50%)", zIndex: 9996, display: "inline-flex", alignItems: "center", gap: 12, height: 40, padding: "0 8px 0 16px", borderRadius: 999, background: INK, color: "#FFFFFF", fontFamily: FONT, fontSize: 13, fontWeight: 600, boxShadow: "0 16px 38px -12px rgba(17,17,26,0.55)" },
  ...
  draftPin: { position: "absolute", transform: "translate(-50%, -100%)", width: 28, height: 28, borderRadius: "50% 50% 50% 2px", border: "2px solid #FFFFFF", background: BLUE, boxShadow: "0 6px 16px -4px rgba(37,99,235,0.6)", display: "inline-flex", alignItems: "center", justifyContent: "center", pointerEvents: "none" },
