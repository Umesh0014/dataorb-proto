...
export const CommandCenterIcon = ({ size = 22, color = "currentColor" }) => (
  <MaterialPath
    size={size}
    color={color}
    d="m300-300 280-100 100-280-280 100-100 280Zm180-120q25 0 42.5-17.5T540-480q0-25-17.5-42.5T480-540q-25 0-42.5 17.5T420-480q0 25 17.5 42.5T480-420Zm0 340q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Z"
  />
);

// Guide (Learning Hub) — Material Symbols `menu_book` glyph; matches the
// book/community-learning motif used by the Figma Guide rail icon.
export const GuideIcon = ({ size = 22, color = "currentColor" }) => (
  <MaterialPath
    size={size}
    color={color}
    d="M560-564v-68q33-14 67.5-21t72.5-7q26 0 51 4t49 10v64q-24-9-48.5-13.5T700-600q-38 0-73 9.5T560-564Zm0 220v-68q33-14 67.5-21t72.5-7q26 0 51 4t49 10v64q-24-9-48.5-13.5T700-380q-38 0-73 9t-67 27Zm0-110v-68q33-14 67.5-21t72.5-7q26 0 51 4t49 10v64q-24-9-48.5-13.5T700-490q-38 0-73 9.5T560-454ZM260-320q47 0 91.5 10.5T440-278v-394q-41-24-87-36t-93-12q-36 0-71.5 7T120-692v396q35-12 69.5-18t70.5-6Zm220 42q44-21 88.5-31.5T700-320q36 0 70.5 6t69.5 18v-396q-33-14-68.5-21t-71.5-7q-47 0-93 12t-87 36v394Zm-40 118q-48-38-104-59t-116-21q-42 0-82.5 11T100-198q-21 11-40.5-1T40-234v-482q0-11 5.5-21T62-752q46-24 96-36t102-12q58 0 113.5 15T480-740q51-30 106.5-45T700-800q52 0 102 12t96 36q11 5 16.5 15t5.5 21v482q0 23-19.5 35t-40.5 1q-37-20-77.5-31T700-240q-60 0-116 21t-104 59Z"
  />
);

// Replay (Learning Hub) — Material Symbols "replay" glyph. Coached
// playback of real calls; shares the 960 viewBox of the other rail icons.
export const ReplayIcon = ({ size = 22, color = "currentColor" }) => (
  <MaterialPath
    size={size}
    color={color}
    d="M480-160q-134 0-227-93t-93-227q0-134 93-227t227-93q69 0 132 28.5T720-690v-110h80v280H520v-80h168q-32-56-87.5-88T480-820q-100 0-170 70t-70 170q0 100 70 170t170 70q77 0 139-44t87-116h84q-28 106-114 173t-196 67Z"
  />
);
...
export const MissionsIcon = ({ size = 22, color = "currentColor" }) => (
  ...
  >
    <path
      d="M16.4503 15.2751C17.6253 13.8334 18.3337 12.0001 18.3337 10.0001C18.3337 5.40008 14.6003 1.66675 10.0003 1.66675C5.40033 1.66675 1.66699 5.40008 1.66699 10.0001C1.66699 14.6001 5.40033 18.3334 10.0003 18.3334C12.0003 18.3334 13.8337 17.6251 15.2753 16.4501C15.5003 16.2667 15.717 16.0667 15.9253 15.8584C15.9503 15.8334 15.967 15.8084 15.9837 15.7917C16.1503 15.6251 16.3087 15.4501 16.4503 15.2751ZM10.0003 16.6667C6.32533 16.6667 3.33366 13.6751 3.33366 10.0001C3.33366 6.32508 6.32533 3.33341 10.0003 3.33341C13.6753 3.33341 16.667 6.32508 16.667 10.0001C16.667 11.5417 16.142 12.9501 15.2587 14.0834L14.067 12.8917C14.642 12.0751 14.9837 11.0834 14.9837 10.0084C14.9837 7.25008 12.742 5.00841 9.98366 5.00841C7.22533 5.00841 4.98366 7.25008 4.98366 10.0084C4.98366 12.7667 7.22533 15.0084 9.98366 15.0084C11.067 15.0084 12.0753 14.6584 12.892 14.0667L14.0753 15.2501C12.9503 16.1417 11.542 16.6667 10.0003 16.6667ZM11.6003 10.4251C11.742 9.87508 11.617 9.27508 11.192 8.84175L11.1753 8.82508C10.5337 8.18341 9.50866 8.17508 8.85866 8.79175C8.85033 8.80008 8.83366 8.80841 8.81699 8.82508C8.16699 9.47508 8.16699 10.5334 8.81699 11.1834L8.83366 11.2001C9.26699 11.6251 9.87533 11.7584 10.4253 11.6084L11.6837 12.8667C11.1837 13.1667 10.6087 13.3501 9.98366 13.3501C8.14199 13.3501 6.65033 11.8584 6.65033 10.0167C6.65033 8.17508 8.14199 6.68341 9.98366 6.68341C11.8253 6.68341 13.317 8.17508 13.317 10.0167C13.317 10.6251 13.142 11.1917 12.8503 11.6834L11.6003 10.4251Z"
      fill={color}
    />
  </svg>
);
...
// Skills (Ask Mira Pro) — four-lobe "atom" mark. Own 20×20 viewBox
// (separate from the Material 960×960 set), single fill set by parent.
export const SkillsIcon = ({ size = 22, color = "currentColor" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M6.66667 2.5C8.02967 2.5 9.23981 3.15445 10 4.16626C10.7602 3.15445 11.9703 2.5 13.3333 2.5C15.6345 2.5 17.5 4.36548 17.5 6.66667C17.5 8.02967 16.8455 9.23981 15.8337 10C16.8455 10.7602 17.5 11.9703 17.5 13.3333C17.5 15.6345 15.6345 17.5 13.3333 17.5C11.9703 17.5 10.7602 16.8455 10 15.8337C9.23981 16.8455 8.02967 17.5 6.66667 17.5C4.36548 17.5 2.5 15.6345 2.5 13.3333C2.5 11.9703 3.15445 10.7602 4.16626 10C3.15445 9.23981 2.5 8.02967 2.5 6.66667C2.5 4.36548 4.36548 2.5 6.66667 2.5ZM9.16667 6.66667C9.16667 8.04738 8.04738 9.16667 6.66667 9.16667C5.28595 9.16667 4.16667 8.04738 4.16667 6.66667C4.16667 5.28595 5.28595 4.16667 6.66667 4.16667C8.04738 4.16667 9.16667 5.28595 9.16667 6.66667ZM10.8333 13.3333C10.8333 14.714 11.9526 15.8333 13.3333 15.8333C14.714 15.8333 15.8333 14.714 15.8333 13.3333C15.8333 11.9526 14.714 10.8333 13.3333 10.8333C11.9526 10.8333 10.8333 11.9526 10.8333 13.3333ZM10.8329 10C10.5176 10.2369 10.2369 10.5176 10 10.8329C9.76307 10.5176 9.48243 10.2369 9.16707 10C9.48243 9.76307 9.76307 9.48243 10 9.16707C10.2369 9.48243 10.5176 9.76307 10.8329 10ZM13.3333 9.16667C14.714 9.16667 15.8333 8.04738 15.8333 6.66667C15.8333 5.28595 14.714 4.16667 13.3333 4.16667C11.9526 4.16667 10.8333 5.28595 10.8333 6.66667C10.8333 8.04738 11.9526 9.16667 13.3333 9.16667ZM9.16667 13.3333C9.16667 11.9526 8.04738 10.8333 6.66667 10.8333C5.28595 10.8333 4.16667 11.9526 4.16667 13.3333C4.16667 14.714 5.28595 15.8333 6.66667 15.8333C8.04738 15.8333 9.16667 14.714 9.16667 13.3333Z"
      fill={color}
    />
  </svg>
);

// Tasks (Ask Mira Pro) — document-with-check mark. Own 20×20 viewBox,
// single fill set by parent.
export const TasksIcon = ({ size = 22, color = "currentColor" }) => (
  ...
  >
    <path
      d="M11.6666 1.66699H4.99992C4.08325 1.66699 3.34159 2.41699 3.34159 3.33366L3.33325 16.667C3.33325 17.5837 4.07492 18.3337 4.99159 18.3337H14.9999C15.9166 18.3337 16.6666 17.5837 16.6666 16.667V6.66699L11.6666 1.66699ZM14.9999 16.667H4.99992V3.33366H10.8333V7.50033H14.9999V16.667ZM7.34992 10.8753L6.16659 12.0503L9.11658 15.0003L13.8333 10.2837L12.6583 9.10866L9.12492 12.642L7.34992 10.8753Z"
      fill={color}
    />
  </svg>
);
