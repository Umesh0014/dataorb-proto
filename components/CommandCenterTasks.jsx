...
// 1:1) shows as a card. The three most critical are shown upfront; "View all"
// reveals the rest. Reuses the shared AttentionItemCard (agent + signal +
// recommended action + 1-click launch); detail opens in the shared drawer.
  ...
  return (
    <section style={tStyles.section}>
      <div style={tStyles.head}>
        ...
        {tasks.length > 3 && (
          <Button variant="text" uppercase={false} onClick={() => setShowAll((s) => !s)}>
