...
// TenantCapacityHero — the committed-capacity header for the Credits &
// Usage page: a prominent used/committed bar, three KPI tiles, the usage
// trend, and the page Save action.
...
const heroStyles = {
  ...
  title: { margin: 0, fontSize: 16, fontWeight: 700, color: "var(--color-text-deep)" },
