...
const STRINGS = {
  ...
  view:           { en: "View",          es: "Vista",        de: "Ansicht",          fr: "Vue",              ar: "عرض" },
  personaTeamLead:{ en: "Team Leader",   es: "Jefe de equipo", de: "Teamleiter",     fr: "Chef d'équipe",    ar: "قائد الفريق" },
  personaAgent:   { en: "Agent",         es: "Agente",       de: "Agent",            fr: "Agent",            ar: "وكيل" },
