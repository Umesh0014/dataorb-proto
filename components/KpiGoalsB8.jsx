...
const s = {
  ...
  title: { fontSize: 16, fontWeight: 500, color: "#171B2C", margin: 0, lineHeight: "24px", letterSpacing: "0.1px" },
  subtitle: { fontSize: 12, fontWeight: 400, color: "#5B5E6F", margin: 0, lineHeight: "18px", letterSpacing: "0.4px" },
  ...
  attnLabel: { fontSize: 11, fontWeight: 600, color: "#5B5E6F", textTransform: "uppercase", letterSpacing: "0.5px" },
